	...
	var sst={
		...
		characterSort:{
			sst:{
				...
				sst_melee:["sst_bowser","sst_peach","sst_zelda","sst_sheik","sst_dr_mario","sst_ganondorf","sst_mr_game_n_watch","sst_marth","sst_young_link","sst_pichu","sst_falco"],
				sst_brawl:["sst_zero_suit_samus","sst_wario","sst_pokemon_trainer_red","sst_meta_knight","sst_ike","sst_toon_link","sst_wolf","sst_snake","sst_dedede","sst_lucario","sst_sonic"],
				...
				sst_ultimate:["sst_dark_samus","sst_daisy","sst_chrom","sst_ridley","sst_simon","sst_richter","sst_k_rool","sst_isabelle","sst_incineroar","sst_terry","sst_byleth_b","sst_byleth_g","sst_ken","sst_joker","sst_steve","sst_alex","sst_hero","sst_minmin"],
				sst_spirits:["sst_dark_link","sst_sans","sst_waluigi","sst_master_hand","sst_springman","sst_rex","sst_cuphead_n_mugman","sst_krystal"],
				...
				sst_sp:["ymk_claude","ymk_isabelle","ska_bobby","ska_olivia","ymk_577","ska_xiaojie","ska_show_k","ymk_yumiko","ska_bowser","ska_professor_toad","ska_geno"],
			},
		},
		character:{
			//武将格式:
			...
			sst_byleth_g:["female","sst_light",3,["sst_potian","sst_shenjiao"],[]],
			sst_byleth_b:["male","sst_light",4,["sst_yanchuan","sst_tianmai"],[]],
			sst_massy:["male","sst_reality",5,["sst_shenfa","sst_shenwu"],[]],
			sst_samus:["female","sst_light",4,["sst_juezhan","sst_zailu"],[]],
			sst_ridley:["male","sst_darkness",5,["sst_baozheng","sst_furan"],[]],
			sst_dark_samus:["female","sst_darkness",3,["sst_yingliu","sst_shunxing"],[]],
			sst_mr_game_n_watch:["male","sst_darkness",3,["sst_shenpan"],[]],
			...
			ymk_isabelle:["female","sst_light",3,["sst_zhongmi","ymk_mihu"],[]],
			...
			sst_sheik:["female","sst_light",3,["sst_nixing","sst_shouyin"],[]],
			...
			sst_springman:["male","sst_spirit",4,["sst_shenbi","sst_lanbo"],[]],
			sst_joker:["male","sst_darkness",3,["sst_daoxin","sst_fanni"],[]],
			sst_rex:["male","sst_spirit",3,["sst_qianban","sst_tanyun"],[]],
			sst_cuphead_n_mugman:["male","sst_spirit",3,["sst_zhuizhai","sst_fanfei"],[]],
			...
			sst_dedede:["male","sst_light",4,["sst_baoshi","sst_wangyan"],["zhu"]],
			...
			sst_minmin:["female","sst_light",3,["sst_longbo","sst_fengcu"],[]],
		...
		characterIntro:{
			...
			*/
			...
			"--------------------------------<br>"+
			"哦～我赢了吗？",
			sst_byleth_g:"1381. 贝雷丝/Byleth (Female)/ベレス<br>"+
			"系列：Fire Emblem（火焰纹章）<br>"+
			"初登场：Fire Emblem: Three Houses（火焰纹章 风花雪月）<br>"+
			"武将作者：mario not mary<br>"+
			"--------------------------------<br>"+
			...
			"--------------------------------<br>"+
			"老师真的很希望你们都能活下来……",
			sst_byleth_b:"1380. 贝雷特/Byleth (Male)/ベレト<br>"+
			"系列：Fire Emblem（火焰纹章）<br>"+
			"初登场：Fire Emblem: Three Houses（火焰纹章 风花雪月）<br>"+
			"武将作者：mario not mary<br>"+
			"--------------------------------<br>"+
			...
			"--------------------------------<br>"+
			"“堕入黑暗”",
			sst_mr_game_n_watch:"0689. Mr. Game & Watch/Mr.ゲーム & ウォッチ<br>"+
			...
			"--------------------------------<br>"+
			"物是人非，沧海桑田……",
			sst_springman:"1287. 弹簧人/Spring Man/スプリングマン<br>"+
			"系列：ARMS（神臂斗士）<br>"+
			"初登场：ARMS（神臂斗士）<br>"+
			"武将作者：mario not mary<br>"+
			"--------------------------------<br>"+
			...
			"--------------------------------<br>"+
			"“莱克斯，你一个人……也已经没问题了吧。”",
			sst_cuphead_n_mugman:"1398. 茶杯头/Cuphead/カップヘッド<br>"+
			"系列：Cuphead（茶杯头）<br>"+
			"初登场：Cuphead（茶杯头）<br>"+
			"武将作者：mario not mary<br>"+
			"--------------------------------<br>"+
			...
			sst_minmin:"1289. 面面/Min Min/ミェンミェン<br>"+
		...
		skill:{
			...
			_sst_jiamian_start:{
				...
				silent:true,
				content:function(){
					_status.sst_jiamian_started=true;
				},
			},
			_sst_sex_select:{
				trigger:{global:"gameStart"},
			...
			sst_huoluan:{
				...
				forced:true,
				content:function(){
					player.chooseToDiscard("祸乱：弃置"+get.cnNumber(player.countUsed()-1)+"张牌",player.countUsed()-1,true,"he");
				},
				ai:{
					effect:{
				...
				content:function () {
					...
					player.chooseTarget(get.prompt2("sst_shengbing"),function(card,player,target){
						...
						for (var i=0;i<_status.event.esx.length;i++) {
							if(!target.isEmpty(get.subtype(_status.event.esx[i]))) bool=false;
						}
			...
			sst_xingchen:{
				...
				filter:function (event, player) {
					...
					for(var i=0;i<event.hs.length;i++){
						if(get.position(event.hs[i],true)=="o"||get.position(event.hs[i],true)=="d"){
							return true;
						}
					}
					return false;
				...
				content:function () {
					...
					for(var i=0;i<trigger.hs.length;i++){
						if(get.position(trigger.hs[i])=="d"){
			...
			sst_guangsuo:{
				...
				filter:function (event, player) {
					...
					for (var i = 0; i < event.targets.length; i++) {
						if (!event.targets[i].isLinked()) bool=true;
					}
					return bool;
				},
				direct:true,
				content:function () {
					...
					for (var i = 0; i < event.targets.length; i++) {
						if (event.targets[i].isLinked()||event.targets[i].isDead()) event.targets.remove(event.targets[i]);
					}
				...
				ai:{
					...
					result:{
						target:function(player,target){
							...
							var bool=false;
							for(var i=0;i<list.length;i++){
								if (get.attitude(player,list[i])>0) bool=true;
							}
							if(!bool) return 0;
			...
			sst_qiuyuan2:{
				...
				filter:function(event,player){
					...
					var bool=false;
					for(var i=0;i<event.targets.length;i++){
						if(event.targets[i]!=player&&event.targets[i].hasZhuSkill("sst_qiuyuan",player)&&event.targets[i].group==player.group) bool=true;
					}
				...
				content:function (){
					...
					if(result.cards&&result.cards.length) {
						...
						if(player.storage.sst_shenjiao){
							player.markSkillCharacter("sst_potian2",player.storage.sst_shenjiao,"破天","你使用的杀额定伤害为"+num+"直到回合结束");
						}
						else{
							player.markSkillCharacter("sst_potian2",player,"破天","你使用的杀额定伤害为"+num+"直到回合结束");
						}
					}
				},
			},
			...
			sst_zailu:{
				...
				content:function (){
					...
					player.draw();
					"step 1"
					if(!player.storage.sst_zailu2) player.storage.sst_zailu2=0;
					if(!player.storage.sst_zailu3) player.storage.sst_zailu3=0;
					/*
					if(game.players.length<=player.storage.sst_zailu3+1){
						game.log(player,"选择了","摸牌阶段摸牌数+1");
						player.popup("摸牌+1");
						player.storage.sst_zailu2++;
						event.finish();
					}
					*/
					player.chooseControl("摸牌阶段摸牌数+1","使用基本牌或普通锦囊牌可以额外指定一个目标").set("ai",function(){
						...
						if(players&&players.length>player.storage.sst_zailu3+1){
			...
			sst_zailu2:{
				...
				forced:true,
				filter:function (event,player){
					return player.storage.sst_zailu2&&!event.numFixed;
				},
				content:function (){
					trigger.num+=player.storage.sst_zailu2;
				},
				ai:{
					threaten:function (player,target){
						if(!player.storage.sst_zailu2) return 1;
						return 1+player.storage.sst_zailu2*0.2;
					},
				},
			},
			sst_zailu3:{
				...
				filter:function (event,player){
					if(!player.storage.sst_zailu3) return false;
				...
				content:function (){
					"step 0"
					player.chooseTarget(get.prompt("sst_zailu"),"为"+get.translation(trigger.card)+"增加目标",[1,player.storage.sst_zailu3],function(card,player,target){
					...
					"step 2"
					player.logSkill("sst_zailu",event.targets);
					trigger.targets.addArray(event.targets);
				},
				ai:{
					threaten:function (player,target){
						if(!player.storage.sst_zailu3) return 1;
						return 1+player.storage.sst_zailu3*0.2;
					},
				},
			},
			sst_baozheng:{
			...
			*/
			...
			sst_fuchou:{
				...
				/*
				init:function(player){
					if(!player.storage.sst_fuchou) player.storage.sst_fuchou=[];
				},
				*/
				filter:function(event,player){
				...
				sync:function(sst_fuchou){
					...
					for(var i=0;i<sst_fuchou.length;i++){
						if(!sst_fuchou[i].parentNode||sst_fuchou[i].parentNode.id!="special"){
							sst_fuchou.splice(i--,1);
						}
					}
					game.broadcast(function(sst_fuchou,cards){
						sst_fuchou=cards;
					},sst_fuchou,sst_fuchou);
				},
				*/
				ai:{
					maixie:true,
			...
			*/
			...
			sst_shengxi:{
				global:["sst_shengxi2","sst_shengxi3","sst_shengxi4"],
				init:function(player){
					var players=game.filterPlayer();
					for(var i=0;i<players.length;i++){
						if(!players[i].storage.sst_shengxi) players[i].storage.sst_shengxi=[];
					}
				},
				//marktext:"袭",
				intro:{
					...
					onunmark:function(storage,player){
						var players=game.filterPlayer();
						for(var i=0;i<players.length;i++){
							if(players[i].storage.sst_shengxi&&players[i].storage.sst_shengxi.length) players[i].storage.sst_shengxi.length=0;
						}
					},
					*/
				},
				onremove:function(player){
					var players=game.filterPlayer();
					for(var i=0;i<players.length;i++){
						if(players[i].storage.sst_shengxi&&players[i].storage.sst_shengxi.length){
							players[i].storage.sst_shengxi.length=0;
							players[i].unmarkSkill("sst_shengxi");
						}
					}
				},
				ai:{
			...
			sst_shengxi2:{
				...
				filter:function(event,player) {
					...
					if(event.target.storage.sst_shengxi&&event.target.storage.sst_shengxi.length){
						for(var i=0;i<event.target.storage.sst_shengxi.length;i++){
							if(cards.contains(event.target.storage.sst_shengxi[i])) cards.remove(event.target.storage.sst_shengxi[i]);
						}
					}
					return game.hasPlayer(function(current){
				...
				content:function(){
					...
					if(trigger.target==player){
						player.chooseCard("h",get.prompt("sst_shengxi",trigger.target),"你可以明置你的一张手牌；一名角色可以使用你的这张手牌",function(card){
							var player=_status.event.player;
							return !player.storage.sst_shengxi.contains(card);
						}).set("ai",function(card){
							return 0;
						});
					}
					else{
						player.chooseBool(get.prompt("sst_shengxi",trigger.target),"你可以明置"+get.translation(trigger.target)+"的一张手牌；一名角色可以使用"+get.translation(trigger.target)+"的这张手牌").set("ai",function(){
							//game.log(get.attitude(_status.event.player,_status.event.targetx))
							return get.attitude(_status.event.player,_status.event.targetx)<0;
						}).set("targetx",trigger.target);
					}
					*/
					player.choosePlayerCard(trigger.target,"h",true,"圣袭：明置"+get.translation(trigger.target)+"的一张手牌").set("filterButton",function(button){
						var target=_status.event.targetx;
						return !target.storage.sst_shengxi.contains(button.link);
					}).set("targetx",trigger.target);
					"step 1"
					if(result.cards&&result.cards.length){
						...
						/*
						if(trigger.target.storage.sst_shengxi.length){
							for(var i=0;i<trigger.target.storage.sst_shengxi.length;i++){
								if(cards.contains(trigger.target.storage.sst_shengxi[i])) cards.remove(trigger.target.storage.sst_shengxi[i]);
							}
						}
						...
						*/
						...
						trigger.target.storage.sst_shengxi.push(card);
						trigger.target.syncStorage("sst_shengxi");
						trigger.target.updateMarks();
						trigger.target.markSkill("sst_shengxi");
						game.delayx();
				...
				ai:{
					...
					effect:{
						player:function(card,player,target){
							...
							if(player.storage.sst_shengxi&&player.storage.sst_shengxi.contains(card)) return [1,3];
						},
					},
				},
			},
			sst_shengxi3:{
				...
				filter:function(event,player) {
					...
					if(!player.storage.sst_shengxi||!player.storage.sst_shengxi.length) return false;
					for(var i=0;i<event.hs.length;i++){
						if(player.storage.sst_shengxi.contains(event.hs[i])) return true;
					}
					return false;
				},
				silent:true,
				content:function(){
					for(var i=0;i<trigger.hs.length;i++){
						if(player.storage.sst_shengxi.contains(trigger.hs[i])){
							player.storage.sst_shengxi.remove(trigger.hs[i]);
							player.syncStorage("sst_shengxi");
							player.updateMarks();
						}
						if(!player.storage.sst_shengxi||!player.storage.sst_shengxi.length){
							player.unmarkSkill("sst_shengxi");
						}
					}
				},
			},
			sst_shengxi4:{
				...
				filter:function(event,player){
					...
					for(var i=0;i<players.length;i++){
						if(players[i].storage.sst_shengxi&&players[i].storage.sst_shengxi.length){
							sst_shengxi=sst_shengxi.concat(players[i].storage.sst_shengxi);
						}
						players[i].syncStorage("sst_shengxi");
					}
				...
				chooseButton:{
					...
					backup:function(links,player){
						return {
							...
							viewAs:links[0],
							onuse:function(result,player){
								player.logSkill("sst_shengxi4_backup");
								/*
								var players=game.filterPlayer();
								for(var i=0;i<players.length;i++){
									if(players[i].storage.sst_shengxi&&players[i].storage.sst_shengxi.length){
								...
								player.storage.sst_shengxi.remove(result.card);
								player.syncStorage("sst_shengxi");
								player.updateMarks();
								if(!player.storage.sst_shengxi||!player.storage.sst_shengxi.length){
									player.unmarkSkill("sst_shengxi");
								...
								*/
								...
								owner.storage.sst_shengxi.remove(result.card);
								owner.line(player,"green");
								game.log(player,"使用了",owner,"的",result.card);
								owner.syncStorage("sst_shengxi");
								owner.updateMarks();
								if(!owner.storage.sst_shengxi||!owner.storage.sst_shengxi.length){
									owner.unmarkSkill("sst_shengxi");
								}
							}
						}
					},
			...
			sst_zhongmi:{
				...
				content:function(){
					...
					player.chooseTarget(get.prompt("sst_zhongmi"),"你可以令一名其他角色摸"+get.cnNumber(event.num)+"张牌，或弃置一名其他角色的"+get.cnNumber(event.num)+"张牌",function(card,player,target){
						return player!=target;
					}).set("ai",function(target){
						var player=_status.event.player;
					...
					"step 1"
					if(result.bool){
						player.logSkill("sst_zhongmi",result.targets);
						event.target=result.targets[0];
			...
			sst_cuifeng:{
				...
				content:function(){
					...
					"step 1"
					player.chooseUseTarget({name:"sha"},[result.card],false).viewAs=true;
				},
				group:["sst_cuifeng2"],
			},
			sst_cuifeng2:{
				...
				content:function(){
					...
					if(event.num<event.players.length){
						if(event.players[event.num].isAlive()){
							//game.log("yes");
							event.players[event.num].chooseToUse("对"+get.translation(player)+"使用一张【杀】，若如此做，你计算与"+get.translation(player)+"距离为1直到"+get.translation(player)+"的下个准备阶段，否则本回合你不能响应"+get.translation(player)+"使用的牌",player,-1).set("filterCard",function(card){
			...
			*/
			...
			sst_yanyang2:{
				trigger:{player:"useCard1"},
				filter:function(event,player){
					return event.skill=="sst_yanyang";
				},
				silent:true,
				content:function(){
					if(typeof trigger.baseDamage!="number") trigger.baseDamage=1;
			...
			sst_yebao2:{
				...
				filter:function(event,player){
					return event.player!=player&&event.source==player&&!event.player.isDead();
				},
				forced:true,
				logTarget:"player",
				content:function (){
					trigger.player.addTempSkill("sst_yebao3",{player:"phaseBegin"});
				},
				ai:{
					effect:{
						player:function(card,player,target){
			...
			sst_yufeng:{
				...
				content:function(){
					"step 0"
					player.chooseToDiscard(get.prompt2("sst_yufeng",trigger.player));
					"step 1"
					if(result.cards&&result.cards.length){
						player.logSkill("sst_yufeng",trigger.player);
			...
			sst_yufeng2:{
				mod:{
					suit:function(card,suit){
						if(get.color(card)==trigger.player.storage.sst_yufeng_color&&trigger.player.storage.sst_yufeng_suit) return trigger.player.storage.sst_yufeng_suit;
					},
				},
			},
			sst_chihang:{
				...
				content:function(){
					...
					player.chooseCardTarget({
						...
						*/
						...
						//prompt:"###"+get.prompt("sst_chihang2")+"###弃置一张红色牌，然后为"+get.translation(trigger.card)+"指定一个额外目标",
					});
					"step 1"
					if(result.bool){
			...
			sst_old_shishi:{
				...
				content:function(){
					...
					game.getGlobalHistory("cardMove",function(evt){
						if(evt.getParent("phaseJieshu")) cards.addArray(evt.cards.filterInD("d"));
					});
					*/
			...
			sst_jiamian:{
				...
				init:function(player){
					...
					if(_status.sst_jiamian_started){
						if(!_status.characterlist){
							var list=[];
							for(var i in lib.character){
								if(lib.filter.characterDisabled2(i)||lib.filter.characterDisabled(i)) continue;
			...
			sst_qianlong:{
				...
				content:function(){
					"step 0"
					player.lose(cards,ui.special,"toStorage");
					player.$giveAuto(cards,player,false);
				...
				group:["sst_qianlong2","sst_qianlong3"],
				ai:{
					respondSha:true,
					result:{
						target:function(player,target){
		...
		dynamicTranslate:{
			...
			sst_guaibi:function(player){
				return "每轮限｛"+player.storage.sst_guaibi+"｝次，一张【杀】指定目标前，你可以弃置一名角色的两张牌，令其成为此【杀】的使用者，然后该角色可以为此【杀】重新指定目标。";
			},
		},
		characterReplace:{
			...
			sst_byleth_b:["sst_byleth_b","sst_byleth_g"],
			sst_yumiko:["sst_yumiko","ymk_yumiko"],
			sst_isabelle:["ymk_isabelle"],
		},//武将替换
		translate: {
			//武将
			sst_mario:"马力欧",
			...
			sst_xingchen:"星尘",
			sst_xingchen_info:"每当你的手牌不因使用而进入处理区或弃牌堆前，你可以将这些牌任意分配给其他角色，然后当前回合角色摸一张牌。",
			sst_zhuansheng:"转生",
			...
			sst_potian:"破天",
			sst_potian2:"破天",
			sst_potian_info:"准备阶段，你可以重铸任意张花色不同的牌，然后你令你使用的杀额定伤害为X直到回合结束（X为你以此法置入弃牌堆的基本牌数量）。",
			sst_shenjiao:"身教",
			sst_shenjiao2:"身教",
			...
			sst_juezhan:"绝战",
			sst_juezhan_info:"锁定技，你于出牌阶段可以额外使用X张【杀】，你的攻击距离+X。（X为你已损失的体力值）",
			sst_zailu:"载录",
			sst_zailu2:"载录",
			sst_zailu3:"载录",
			sst_zailu_info:"一名角色死亡后，你可以摸一张牌，然后选择一项：1. 令你本局游戏中摸牌阶段摸牌数+1；2. 使用基本牌或普通锦囊牌可以额外指定一个目标。",
			sst_baozheng:"暴征",
			sst_baozheng2:"暴征",
			...
			sst_fuchou4:"复仇",
			sst_fuchou_info:"你受到伤害后，你可以将造成伤害的牌置于你的武将牌上，你可以将这些牌如手牌般使用或打出，你使用这些牌造成伤害时，此伤害+1。",
			sst_huanbian:"幻变",
			sst_huanbian2:"幻变",
			sst_huanbian3:"幻变",
			...
			sst_zhongmi:"忠秘",
			sst_zhongmi_info:"你的回合外，当你获得或不因使用或打出而失去牌时，你可以选择一项：1. 令一名其他角色摸X+1张牌；2. 弃置一名其他角色的X+1张牌。（X为你损失的体力值）",
			ymk_mihu:"迷糊",
			...
			sst_renqing:"任情",
			sst_renqing2:"任情",
			sst_renqing_info:"你的回合内，不以此法执行的摸牌阶段，出牌阶段，弃牌阶段开始前，你可以跳过此阶段，改为从上述其他两个阶段选择一个执行。若如此做，本回合结束时，若本回合没有执行过弃牌阶段，你失去一点体力。",
			sst_manchan:"蛮缠",
			...
			sst_suxing:"溯行",
			sst_suxing_info:"锁定技，每轮游戏开始时，若上一轮你失去过所有手牌，你执行一个额外的回合。",
			sst_shengyi:"圣裔",
			...
			*/
			...
			sst_yanyang:"焰扬",
			sst_yanyang2:"焰扬",
			sst_yanyang_info:"你可以将至多两张牌当作【火攻】使用；你以此法使用的【火攻】造成伤害时，其基础伤害为其对应实体牌数。",
			sst_shenglong:"升龙",
			sst_shenglong_info:"锁定技，与你距离最近的角色不能响应你使用的牌。",
			sst_juexin:"决心",
			sst_juexin_info:"锁定技，当你受到伤害或失去体力时，取消之；你的手牌上限+2。",
			sst_yebao:"业报",
			sst_yebao2:"业报",
			sst_yebao3:"业报",
			sst_yebao_info:"锁定技，你对一名角色造成伤害时，若其未使用过【杀】，取消之；其他角色受到你造成的伤害后，直到其回合开始，每个回合结束时，其弃置一张牌。",
			sst_caijue:"裁决",
			...
			sst_qichang3:"绮裳",
			sst_qichang4:"绮裳",
			sst_qichang_info:"准备阶段，你可以令你本回合手牌上限-1，然后你视为对你使用一张装备牌（不得替换原装备，不能被弃置或获得），你的回合开始时或失去此牌后，销毁之。",
			sst_shizhu:"拾珠",
			sst_shizhu_info:"你/其他角色的弃牌阶段结束时，你可以令一名其他角色/你可以弃置与你/其于此阶段弃置牌等量的牌，若如此做，你可以从你与其弃置的牌中选择任意张对你或其使用。",
			ska_kezhi:"恪志",
			ska_kezhi2:"恪志",
			...
			sst_shishi:"时逝",
			sst_shishi_info:"锁定技，准备阶段，若你未受伤，你弃置一名角色的一张牌；若你已受伤，你视为使用一张【杀】，然后若未造成伤害，你将武将牌变更为【时光的笛音·林克】 。",
			...
			sst_qianlong2:"潜龙",
			sst_qianlong3:"潜龙",
			sst_qianlong_info:"出牌阶段限一次，你可以将一张牌扣置于武将牌上视为使用一张【杀】，若此【杀】造成了伤害，你展示此牌并对此目标使用，否则此【杀】结算完毕后你将此牌置于弃牌堆。",
			ska_lunli:"论理",
			...
			sst_yinyao:"音谣",
			sst_yinyao_info:"准备阶段，你可以展示并弃置一张手牌，然后从你下家开始到你上家为止，每名角色须依次展示与其上家所展示的牌花色或点数相同的牌，否则其翻面并结束此流程。",
			sst_anke:"安可",
			sst_anke2:"安可",
			...
			sst_tankuang:"探矿",
			sst_tankuang_info:"出牌阶段，你可以按花色或类别举荐一张牌，其间若本回合因此进入弃牌堆的牌达到十张，中止此流程且本回合不能再发动此技能，然后你受到1点伤害。",
		...
		perfectPair:{
			sst_mario:["sst_yoshi","sst_dr_mario","sst_rosalina","sst_luigi","sst_bowser","sst_peach","sst_donkey_kong","sst_daisy","sst_bowser_jr","sst_koopalings","sst_wario","sst_waluigi","ska_olivia","ska_bobby","ska_xiaojie","ska_professor_toad","ska_geno"],
			sst_bowser:["sst_bowser_jr","sst_koopalings","sst_peach","ska_geno"],
			sst_bowser_jr:["sst_koopalings"],
			sst_luigi:["sst_yoshi","sst_peach","sst_daisy","ska_xiaojie"],
			sst_peach:["sst_yoshi","sst_daisy","ska_geno"],
			...
			sst_byleth_b:["sst_byleth_g"],
			sst_simon:["sst_richter"],
			sst_mnm:["sst_yumiko","sst_bowser","ymk_yumiko"],
			sst_yumiko:["sst_terry"],
			sst_kyuukou:["sst_incineroar"],
			sst_oc:["sst_bowser"],
			sst_windier:["sst_little_mac"],
			ska_olivia:["ska_bobby","ska_professor_toad"],
			sst_ryu:["sst_ken"],
