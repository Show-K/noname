...
game.import("character",function(lib,game,ui,get,ai,_status){
	var sst_sp={
		...
		character:{
			...
			ska_bobby:["male","sst_spirit",4,["ska_jixing","ska_daishi","ska_yangxun"],[]],
			...
			*/
			ska_fuyuan:{
				...
				content:function(){
					...
					player.chooseTarget(get.prompt("ska_fuyuan"),str).set("ai",function(target){
