...
game.import("character",(lib,game,ui,get,ai,_status)=>{
	...
	const SST_SP={
		...
		connect:true,
		character:{
			ymk_isabelle:["female","sst_light",3,["ymk_zhongmi","ymk_mihu"],["type:grab"]],
			ska_bobby:["male","sst_spirit",3,["ska_jixing","ska_yangxun","ska_wangshi"],["type:neutral","feature:若〖惘事〗的使命成功，你的类型视为攻击。"]],
			ska_olivia:["female","sst_spirit",3,["ska_shenqi","ska_zhefu"],["type:shield"]],
			ska_super_xiaojie:["male","sst_reality",3,["ska_kezhi","ska_jiyan"],["type:unknown"]],
			ska_show_k:["male","sst_reality",3,["ska_jingli","ska_zhiyi"],["type:unknown"]],
			ymk_yumikohimi:["female","sst_reality",3,["ymk_qiuyi","ymk_xifang"],["type:unknown"]],
			ska_professor_toad:["male","sst_spirit",3,["ska_juegu","ska_kuiwang"],["type:grab"]],
			mnm_edelgard:["female","sst_spirit",3,["mnm_tianjiu","mnm_yanhai"],["type:attack"]],
			alz_kyo_kusanagi:["male","sst_spirit",4,["alz_wushi","alz_huangyao"],["type:attack"]],
			mnm_captain_falcon:["male","sst_light",4,["mnm_jijing"],["type:attack"]],
			ska_king_olly:["male","sst_spirit",3,["ska_shenqi_alter","ska_zhesheng"],["type:attack"]],
			ska_koopa_troopa:["male","sst_spirit",3,["ska_suixuan","ska_xiangshi"],["type:grab"]],
			mnm_9_volt_18_volt:["male","sst_spirit",4,["mnm_huaijiu"],["type:shield"]],
			nnk_robin:["","sst_dark",4,["nnk_yuanlei"],["type:grab"]],
			nnk_robin_female:["female","sst_dark",4,["nnk_yuanlei"],["type:grab","unseen"]],
			nnk_robin_male:["male","sst_dark",4,["nnk_yuanlei"],["type:grab","unseen"]],
			alz_yuri_kozukata:["female","sst_spirit",3,["alz_yingjian","alz_qushui"],["type:attack"]],
			ymk_tianyi:["male","sst_reality",4,["ymk_kaibai"],["type:unknown"]],
			xsj_yu_narukami:["male","sst_spirit",3,["xsj_dongqie","xsj_taluo"],["type:grab"]],
			xsj_dante:["male","sst_spirit",4,["xsj_wanxie","xsj_moxue"],["type:attack"]],
			ska_daroach:["male","sst_spirit",3,["ska_zhidai","ska_siyi"],["hiddenSkill","type:attack"]],
			nnk_decidueye:["male","sst_spirit",4,["nnk_fengying","nnk_biantou"],["type:attack"]],
			nnk_machamp:["male","sst_spirit",4,["nnk_manwu","nnk_mianyu"],["type:grab"]],
		...
		translate:{
			...
			mnm_yanhai:"炎骸",
			mnm_yanhai2:"炎骸",
			mnm_yanhai_info:`觉醒技，若你不是主公，你死亡前，改为将体力回复至2点，摸三张牌，所有角色视为在你攻击范围内，胜利条件变更为：<span style="font-family: LXGWWenKaiGBScreen">成为唯一存活者</span>。`,
			alz_wushi:"无式",
			...
			mnm_huaijiu_append:`<span style="font-family: LXGWWenKaiGBScreen">*可选武将：曹操、司马懿、夏侯惇、张辽、许褚、郭嘉、甄姬、刘备、关羽、张飞、诸葛亮、赵云、马超、黄月英、孙权、甘宁、吕蒙、黄盖、周瑜、大乔、陆逊、孙尚香、华佗、吕布、貂蝉、华雄、袁术、公孙瓒、伊籍</span>`,
			mnm_huaijiu_faq:"*",
			...
			ska_fuwu_append:`<span style="font-family: LXGWWenKaiGBScreen">*左/右移一位；移位方向改为左/右。</span>`,
			ska_fuwu_faq:"*",
