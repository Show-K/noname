...
game.import("card",function(lib,game,ui,get,ai,_status){
	...
	const SST_SP={
		...
		translate:{
			...
			ska_sauce_append:"<span class=\"text\" style=\"font-family: twkai\">“这里是我的一个……我吃的一些酱料啊。”——超级小桀</span>",
			...
			ska_rise_of_the_block_append:"<span class=\"text\" style=\"font-family: twkai\">我们至今不知道为什么Tweek在那次比赛惨败给那个史蒂夫选手。</span>",
			...
			ska_doing_absolutely_nothing_append:"<span class=\"text\" style=\"font-family: twkai\">“路易吉这角色就离谱！”——超级小桀</span>",
			ska_doing_absolutely_nothing_skill:"不动定律",
			ska_big_merger:"大收购",
			ska_big_merger_info:"出牌阶段，对一名区域内有可获得牌的其他角色使用。你摸两张牌，获得目标角色区域内所有牌，然后交给其至少等量牌。",
			ska_big_merger_append:"<span class=\"text\" style=\"font-family: twkai\">Microsoft怎么就这么有钱呢！</span>",
			ska_pumpkin:"南瓜",
			ska_pumpkin_info:"出牌阶段，对一名有牌的其他角色使用。目标角色选择一项：1. 令你弃置其两张牌，然后你失去1点体力；2. 其弃置一张牌，然后本轮非锁定技失效。",
			ska_pumpkin_append:"<span class=\"text\" style=\"font-family: twkai\">困难模式第一人在背题，多人对战8,000分在背题，我呢？我被任天堂封了14天。</span>",
			//Skill
