...
game.import("card",(lib,game,ui,get,ai,_status)=>{
	...
	const SST_STANDARD={
		...
		translate:{
			...
			sst_spear_thrust_append:"<span class=\"text\" style=\"font-family: twkai\">吾乃噗噗噗大陆头巾瓦豆鲁迪也！</span>",
			//Equip
			sst_aegises:"天之圣杯",
			sst_aegises_info:"转换技，出牌阶段限一次，你可以与①一名角色②牌堆顶的一张牌拼点，赢的一方获得没赢的一方拼点的牌，然后若你没有获得牌，你对一名角色造成1点①火焰②雷电伤害。",
			sst_aegises_append:"<span class=\"text\" style=\"font-family: twkai\">所以到底算不算大家。</span>",
			sst_ink:"墨水",
			sst_ink_info:"锁定技，你计算与其他角色的距离+1，【鱿鱼】对你造成的伤害+1。",
			sst_ink_append:"<span class=\"text\" style=\"font-family: twkai\">禁止泼墨！</span>",
			//Skill
